...
DEFAULT_TEMPERATURES: List[float] = [0.5, 1.5, 2.5, 3.5, 4.5, 5.5]
...
TEMPERATURE_BASE_FOLDER = eval_out_relative('temperature')  # noqa: F405
TEMPERATURE_RESULTS_FOLDER = TEMPERATURE_BASE_FOLDER / 'eval_out'
TEMPERATURE_RESULTS_CLASSIFICATION_FOLDER = TEMPERATURE_RESULTS_FOLDER / 'classification'
TEMPERATURE_RESULTS_REGRESSION_FOLDER = TEMPERATURE_RESULTS_FOLDER / 'regression'
TEMPERATURE_RESULTS_SUMMARY_FOLDER = TEMPERATURE_RESULTS_FOLDER / 'summaries'
TEMPERATURE_RESULTS_LAMBDA_FOLDER = TEMPERATURE_RESULTS_FOLDER / 'lambda'
TEMPERATURE_DENSITY_SCRIPT_TAG = Path('..') / 'temperature' / 'data_density'


def ensure_output_dirs() -> Dict[str, Path]:
    directories = {
        'base': ensure_project_dir(TEMPERATURE_BASE_FOLDER),  # noqa: F405
        'classification': ensure_project_dir(TEMPERATURE_RESULTS_CLASSIFICATION_FOLDER),  # noqa: F405
        'regression': ensure_project_dir(TEMPERATURE_RESULTS_REGRESSION_FOLDER),  # noqa: F405
        'lambda': ensure_project_dir(TEMPERATURE_RESULTS_LAMBDA_FOLDER),
        'summaries': ensure_project_dir(TEMPERATURE_RESULTS_SUMMARY_FOLDER),  # noqa: F405
    }
    return directories
...
def run_trial_for_temperature(
    ...
    density_cls_path = save_density_snapshot(
        script_tag=TEMPERATURE_DENSITY_SCRIPT_TAG,
        task='classification',
